...
const Home = ({ navigation }) => {
    ...
    const bookOtherWordsForHome = {
        ...
        readed: "12k",
        description: "Mimoshiki tells Boruto that he is bound to lose everything because of his eyes, or in the case of Boruto, because of his right eye. However, many fans have wondered how this would be possible. When the series begins, Boruto is about to face Kawaki in battle, and we see Konoha destroyed. While some fans have speculated that this was Kawaki's doing, others have theorized that the destruction may be caused by Boruto's Jogan. Unknowingly, Boruto could have also easily taken out Naruto with his Jogan.",
    ...
    const bookTheMetropolis = {
        ...
        readed: "13k",
        description: "According to Boruto, Naruto refers to Sasuke as the Shadow Hokage, due to Naruto protecting the village from the inside whereas Sasuke supports Naruto and protects the village from the outside. However, Sasuke never recognises himself as a Hokage due to his past criminal acts and his personal life-long journey of atonement. His ambition was also formed by some experience in the past when he saw his clan and his family was killed by his brother before his very eyes. It made him going mad and promised not to surrender before he killed his brother by his own hand. Moreover, in reaching his ambition, he did many things even those could endanger himself and disobeying his friend. Because he believes that no one can help and stop him to seize his ambition. On the other hand, sasuke was born in the oldest and the strongest clan in konoha. Therefore, the feeling of higher and better than other people was created since he was child. The last, he likes to challenge his friend or enemy as a way to prove that he was stronger than other",
    ...
    function renderHeader(profile) {
        return (
            <View style={{ marginTop: 40, flex: 1, flexDirection: 'row', paddingHorizontal: SIZES.padding, alignItems: 'center' }}>
                {/* Greetings */}
                <View style={{ flex: 1 }}>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                        <View style={{ width: 30, height: 30, alignItems: 'center', justifyContent: 'center', borderRadius: 25, backgroundColor: '#000' }}>
                            <Image
                ...
                <View style={{ flexDirection: 'row', height: 70, backgroundColor: COLORS.secondary, borderRadius: SIZES.radius }}>
                    ...
                    >
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body3, color: COLORS.white }}>Watch</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body3, color: COLORS.white }}>Search</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body3, color: COLORS.white }}>Subscribe</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
